...
var Filterizr = function (t) {
  ...
  var r = {
    ...
    if (void 0 !== e) {
      var o = new Error('Filterizr: expected type of option "' + t + '" to be "' + n + '", but its type is: "' + _typeof(e) + '"'),
          s = !1,
          a = !1,
          u = n.includes("array");
      if (_typeof(e).match(n) ? s = !0 : !s && u && (a = Array.isArray(e)), !s && !u) throw o;
      if (!s && u && !a) throw o;
  ...
  var _S,
    ...
    return Z(e, t), e.prototype.initialize = function () {
      var t;
      this.set((t = this.options, _B({}, Q(t), {
        position: "relative",
        width: "100%",
        display: "flex",
        flexWrap: "wrap"
  ...
  function ft(t) {
    ...
    t.fn.filterizr = function () {
      ...
      if (!this._fltr && 0 === n.length || 1 === n.length && "object" == _typeof(n[0])) {
      ...
      return function (t, e) {
        ...
        function s(t, e, a) {
          ...
          "string" == typeof t && (u = document.querySelectorAll(t)), u ? (this.elements = function (t) {
            ...
            if ("object" == _typeof(t) && "number" == typeof t.length) return o.call(t);
            return [t];
