...
!function (e) {
  ...
  var p = function () {
    ...
    return d(F, null, [{
      ...
      value: function value() {
        this.prototype.Emitter = p, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
          ...
          resize: function resize(e, t, n, i) {
            ...
            if (r.srcWidth > t || r.srcHeight > n) if ("crop" === i) o < a ? (r.srcHeight = e.height, r.srcWidth = r.srcHeight * o) : (r.srcWidth = e.width, r.srcHeight = r.srcWidth / o);else {
          ...
          addedfile: function addedfile(t) {
            ...
            if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
              var _s = function _s(e) {
                return e.preventDefault(), e.stopPropagation(), t.status === F.UPLOADING ? F.confirm(n.options.dictCancelUploadConfirmation, function () {
                  return n.removeFile(t);
                }) : n.options.dictRemoveFileConfirmation ? F.confirm(n.options.dictRemoveFileConfirmation, function () {
                  return n.removeFile(t);
                }) : n.removeFile(t);
              };
              ...
              var e,
                  i = w(t.previewElement.querySelectorAll("[data-dz-name]"));
              ...
              var a,
                  o = w(t.previewElement.querySelectorAll("[data-dz-size]"));
              ...
              this.options.addRemoveLinks && (t._removeLink = F.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>")), t.previewElement.appendChild(t._removeLink));
              var l,
                  u = w(t.previewElement.querySelectorAll("[data-dz-remove]"));

              try {
                for (u.s(); !(l = u.n()).done;) {
                  l.value.addEventListener("click", _s);
                }
              } catch (e) {
                u.e(e);
              } finally {
          ...
          thumbnail: function thumbnail(e, t) {
            if (e.previewElement) {
              ...
              var n,
                  i = w(e.previewElement.querySelectorAll("[data-dz-thumbnail]"));
          ...
          error: function error(e, t) {
            if (e.previewElement) {
              ...
              var n,
                  i = w(e.previewElement.querySelectorAll("[data-dz-errormessage]"));
          ...
          uploadprogress: function uploadprogress(e, t) {
            if (e.previewElement) {
              var n,
                  i = w(e.previewElement.querySelectorAll("[data-dz-uploadprogress]"));
          ...
          return a.listeners.push({
            ...
            events: {
              click: function click(e) {
                return t === a.element && e.target !== a.element && !F.elementInside(e.target, a.element.querySelector(".dz-message")) || a.hiddenFileInput.click(), !0;
              }
            }
          });
      ...
      key: "destroy",
      value: function value() {
        return this.disable(), this.removeAllFiles(!0), null != this.hiddenFileInput && this.hiddenFileInput.parentNode && (this.hiddenFileInput.parentNode.removeChild(this.hiddenFileInput), this.hiddenFileInput = null), delete this.element.dropzone, F.instances.splice(F.instances.indexOf(this), 1);
      }
    }, {
              ...
              try {
                for (n.s(); !(t = n.n()).done;) {
                  ...
                  i.isFile ? i.file(function (e) {
                    if (!o.options.ignoreHiddenFiles || "." !== e.name.substring(0, 1)) return e.fullPath = "".concat(a, "/").concat(e.name), o.addFile(e);
                  }) : i.isDirectory && o._addFilesFromDirectory(i, "".concat(a, "/").concat(i.name));
                }
              } catch (e) {
                n.e(e);
              } finally {
      ...
      key: "accept",
      value: function value(e, t) {
        this.options.maxFilesize && e.size > 1024 * this.options.maxFilesize * 1024 ? t(this.options.dictFileTooBig.replace("{{filesize}}", Math.round(e.size / 1024 / 10.24) / 100).replace("{{maxFilesize}}", this.options.maxFilesize)) : F.isValidFile(e, this.options.acceptedFiles) ? null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles ? (t(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}", this.options.maxFiles)), this.emit("maxfilesexceeded", e)) : this.options.accept.call(this, e, t) : t(this.options.dictInvalidFileType);
      }
    }, {
      key: "addFile",
      value: function value(t) {
        ...
        }, this.files.push(t), t.status = F.ADDED, this.emit("addedfile", t), this._enqueueThumbnail(t), this.accept(t, function (e) {
      ...
      value: function value(e) {
        var t = this;
        if (e.status !== F.ADDED || !0 !== e.accepted) throw new Error("This file can't be queued because it has already been processed or was rejected.");
        if (e.status = F.QUEUED, this.options.autoProcessQueue) return setTimeout(function () {
      ...
      key: "removeFile",
      value: function value(e) {
        if (e.status === F.UPLOADING && this.cancelUpload(e), this.files = f(this.files, e), this.emit("removedfile", e), 0 === this.files.length) return this.emit("reset");
      }
    }, {
      key: "removeAllFiles",
      value: function value(e) {
      ...
      key: "resizeImage",
      value: function value(r, e, t, n, a) {
        var o = this;
      ...
      value: function value(a, o, s, l, t, u, e) {
        var c = this,
        ...
        return e && (d.crossOrigin = e), t = "from-image" != getComputedStyle(document.body).imageOrientation && t, d.onload = function () {
          ...
          return "undefined" != typeof EXIF && null !== EXIF && t && (e = function e(_e4) {
            return EXIF.getData(d, function () {
              return _e4(EXIF.getTag(this, "Orientation"));
            });
          }), e(function (e) {
          ...
          if (l[0].upload.chunked) {
            ...
            if (r.upload.finishedChunkUpload = function (e) {
              ...
              for (var n = 0; n < r.upload.totalChunkCount; n++) {
                if (void 0 === r.upload.chunks[n]) return _i2();
      ...
      value: function value(t, e) {
        ...
        r.open(o, s, !0), r.timeout = this.resolveOption(this.options.timeout, t), r.withCredentials = !!this.options.withCredentials, r.onload = function (e) {
      ...
      value: function value(e) {
        if ("FORM" === this.element.tagName) {
          var t,
              n = w(this.element.querySelectorAll("input, textarea, select, button"));
          ...
          try {
            for (n.s(); !(t = n.n()).done;) {
              ...
              if (a = a && a.toLowerCase(), null != r) if ("SELECT" === i.tagName && i.hasAttribute("multiple")) {
                var o,
                    s = w(i.options);
      ...
      value: function value(e, t, n) {
        ...
        if (void 0 !== n) {
          if (i = 100 * n.loaded / n.total, e[0].upload.chunked) {
            ...
            for (var o = r.upload.bytesSent = 0; o < r.upload.totalChunkCount; o++) {
              void 0 !== r.upload.chunks[o] && void 0 !== r.upload.chunks[o].progress && (r.upload.progress += r.upload.chunks[o].progress, r.upload.total += r.upload.chunks[o].total, r.upload.bytesSent += r.upload.chunks[o].bytesSent);
            }
  ...
  h.initClass(), h.version = "5.7.2", h.options = {}, h.optionsForElement = function (e) {
    ...
    if (document.querySelectorAll) a = document.querySelectorAll(".dropzone");else {
      ...
      a = [];
      _e5(document.getElementsByTagName("div")), _e5(document.getElementsByTagName("form"));
    }
    return function () {
      var e,
          t = [],
    ...
    for (var t = atob(e.split(",")[1]), n = e.split(",")[0].split(":")[1].split(";")[0], i = new ArrayBuffer(t.length), r = new Uint8Array(i), a = 0, o = t.length, s = 0 <= o; s ? a <= o : o <= a; s ? a++ : a--) {
      r[a] = t.charCodeAt(a);
    }
  ...
  }), null != t ? t.exports = h : window.Dropzone = h, h.ADDED = "added", h.QUEUED = "queued", h.ACCEPTED = h.QUEUED, h.UPLOADING = "uploading", h.PROCESSING = h.UPLOADING, h.CANCELED = "canceled", h.ERROR = "error", h.SUCCESS = "success";

  var v = function v(e, t, n, i, r, a, o, s, l, u) {
    var c = function (e) {
      e.naturalWidth;
      ...
      for (var r = i.getImageData(1, 0, 1, t).data, a = 0, o = t, s = t; a < s;) {
  ...
  return h._autoDiscoverFunction = function () {
    ...
    function i(e) {
      if ("readystatechange" !== e.type || "complete" === a.readyState) return ("load" === e.type ? t : a)[l](u + e.type, i, !1), !r && (r = !0) ? n.call(t, e.type || e) : void 0;
    }
