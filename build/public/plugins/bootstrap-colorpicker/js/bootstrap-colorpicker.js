...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      var Extension = function () {
        ...
        _createClass(Extension, [{
          ...
          key: 'onCreate',
          value: function onCreate(event) {} // to be extended
          ...
          key: 'onUpdate',
          value: function onUpdate(event) {} // to be extended
          ...
          key: 'onChange',
          value: function onChange(event) {} // to be extended
          ...
          key: 'onInvalid',
          value: function onInvalid(event) {} // to be extended
          ...
          key: 'onHide',
          value: function onHide(event) {} // to be extended
          ...
          key: 'onShow',
          value: function onShow(event) {} // to be extended
          ...
          key: 'onDisable',
          value: function onDisable(event) {} // to be extended
          ...
          key: 'onEnable',
          value: function onEnable(event) {// to be extended
          }
        }]);
    ...
    function (module, exports, __webpack_require__) {
      /* MIT license */
      var cssKeywords = __webpack_require__(5); // NOTE: conversions should only return primitive values (i.e. arrays, or
    ...
    function (module, exports, __webpack_require__) {
      ...
      _jquery2["default"][plugin] = _Colorpicker2["default"]; // Colorpicker jQuery Plugin API
      ...
      _jquery2["default"].fn[plugin] = function (option) {
        ...
        var $elements = this.each(function () {
          var $this = (0, _jquery2["default"])(this),
              ...
              options = (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object' ? option : {}; // Create instance if does not exist
    ...
    function (module, exports, __webpack_require__) {
      ...
      var Colorpicker = function () {
        ...
        _createClass(Colorpicker, [{
          ...
          value: function init() {
            // Init addon
            this.addonHandler.bind(); // Init input

            this.inputHandler.bind(); // Init extensions (before initializing the color)

            this.initExtensions(); // Init color

            this.colorHandler.bind(); // Init picker

            this.pickerHandler.bind(); // Init sliders and popup

            this.sliderHandler.bind();
            this.popupHandler.bind(); // Inject into the DOM (this may make it visible)

            this.pickerHandler.attach(); // Update all components
          ...
          value: function setValue(val) {
            ...
            this.trigger('colorpickerChange', ch.color, val); // force update if color has changed to empty
          ...
          value: function load() {
            ...
            _jquery2["default"].each(this.colors, function (name, value) {
              var $swatch = (0, _jquery2["default"])(_this2.options.swatchTemplate).attr('data-name', name).attr('data-value', value).attr('title', isAliased ? name + ': ' + value : value).on('mousedown.colorpicker touchstart.colorpicker', function (e) {
                var $sw = (0, _jquery2["default"])(this); // e.preventDefault();
        ...
        _createClass(SliderHandler, [{
          ...
          value: function defaultOnMove(top, left) {
            ...
            var slider = this.currentSlider,
                cp = this.colorpicker,
                ch = cp.colorHandler; // Create a color object

            var color = !ch.hasColor() ? ch.getFallbackColor() : ch.color.getClone(); // Adjust the guide position

            slider.guideStyle.left = left + 'px';
            slider.guideStyle.top = top + 'px'; // Adjust the color
          ...
          value: function pressed(e) {
            ...
            var target = (0, _jquery2["default"])(e.target); // detect the slider and set the limits and callbacks
          ...
          value: function released(e) {
            ...
            this.colorpicker.lastEvent.e = e; // e.stopPropagation();
            // e.preventDefault();
      ...
      var PopupHandler = function () {
        ...
        _createClass(PopupHandler, [{
          ...
          value: function bind() {
            ...
            cp.picker.addClass('colorpicker-popup colorpicker-hidden'); // there is no input or addon
          ...
          value: function show(e) {
            ...
            cp.lastEvent.e = e; // Prevent showing browser native HTML5 colorpicker
          ...
          value: function hide(e) {
            ...
            cp.lastEvent.e = e; // TODO: fix having to click twice outside when losing focus and last 2 clicks where inside the colorpicker
          ...
          value: function fireHide() {
            this.hidding = false;
            this.showing = false;
            var cp = this.colorpicker; // add hidden class after popover is hidden

            cp.picker.addClass('colorpicker-hidden').removeClass('colorpicker-visible'); // Unbind window and document events, since there is no need to keep them while the popup is hidden
      ...
      var PickerHandler = function () {
        ...
        _createClass(PickerHandler, [{
          ...
          value: function update() {
            ...
            var hsva = this.color.toHsvaRatio(); // Set guides position
