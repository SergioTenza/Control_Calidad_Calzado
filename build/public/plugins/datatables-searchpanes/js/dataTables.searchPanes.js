  ...
  function () {
    ...
    SearchPane.prototype._search = function (filter, dataIndex) {
      ...
      for (var _i = 0, _a = this.selections; _i < _a.length; _i++) {
        var colSelect = _a[_i]; // if the filter is an array then is the column present in it
  ...
  function () {
    ...
    SearchPanes.prototype._serverTotals = function () {
      ...
      if (!selectPresent) {
        ...
        for (var i = 0; i < this.s.selectionList.length; i++) {
          ...
          if (!further && this.s.panes[this.s.selectionList[i].index].s.dtPane.rows({
            selected: true
          }).data().toArray().length > 0) {
            newSelectionList.push(this.s.selectionList[i]);
          }
      ...
      if (deselectPresent && this.s.selectionList.length === 1) {
        for (var _b = 0, _c = this.s.panes; _b < _c.length; _b++) {
          ...
          for (var _d = 0, _e = this.s.panes; _d < _e.length; _d++) {
            ...
            for (var _f = 0, _g = this.s.panes; _f < _g.length; _f++) {
              var pane = _g[_f]; // pane.s.lastSelect = (pane.s.deselect === true);
    ...
    SearchPanes.prototype._startup = function (table) {
      ...
      for (var _h = 0, _j = this.s.panes; _h < _j.length; _h++) {
        ...
        if (pane !== undefined && pane.s.dtPane !== undefined && (pane.s.colOpts.preSelect !== undefined || pane.customPaneSettings.preSelect !== undefined)) {
