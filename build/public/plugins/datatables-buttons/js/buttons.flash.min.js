...
(function (g) {
      ...
      if (g.isPlainObject(d)) x(d);else {
        if (r) {
          ...
          for (f = i.length; e < f; e++) {
            k = d.createAttribute(i[e].name.replace(":", "_dt_b_namespace_token_")), k.value = i[e].value, c.setAttributeNode(k);
          }
        }
  ...
  var y = function y(a, b) {
    ...
    return a.newline ? a.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n";
      ...
      A = function A(a, b) {
    for (var d = z(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), i = b.escapeChar !== p ? b.escapeChar : "\\", j = function j(a) {
      for (var b = "", c = 0, d = a.length; c < d; c++) {
        0 < c && (b += f), b += e ? e + ("" + a[c]).replace(g, i + e) + e : a[c];
      }

      return b;
    }, m = b.header ? j(c.header) + d : "", o = b.footer && c.footer ? d + j(c.footer) : "", n = [], l = 0, h = c.body.length; l < h; l++) {
      n.push(j(c.body[l]));
    }
    ...
    footer: !1
      ...
      v = "",
      v = "undefined" === typeof j.XMLSerializer ? new function () {
    ...
    action: function action(a, b, d, c) {
      ...
      var a = c._flash,
        ...
        for (var b = 0, d = a.length; b < d; b++) {
          var g = w(b) + "" + j,
              h = null;
          if (null === a[b] || a[b] === p || "" === a[b]) if (!0 === c.createEmptyCells) a[b] = "";else continue;
      ...
      for (var s = 0, r = k.body.length; s < r; s++) {
        h(k.body[s], e);
      }
