...
(function (e) {
  ...
  e.extend(p.prototype, {
    ...
    _popover: function _popover(a, b, c) {
      ...
      if ("absolute" === k && (c.hasClass(g.rightAlignClassName) || c.hasClass(g.leftAlignClassName) || "dt-container" === g.align)) {
        ...
        top: n.top + f.outerHeight(),
        left: n.left
      }), j = c.outerHeight(), k = f.offset().top, o = 0, o = f.offset().left, u = f.outerWidth(), u = o + u, k = c.offset().left, s = a.width(), s = k + s, l = n.top - j - 5, i = d.offset().top + d.height(), t = n.top + f.outerHeight() + j, i = t - i, t = n.top - j, m = d.offset().top, (i > m - t || g.dropup) && -l < m && c.css("top", l), o = "button-right" === g.align ? u - s : o - k, c.css("left", c.position().left + o)) : (k = c.height() / 2, k > e(q).height() / 2 && (k = e(q).height() / 2), c.css("marginTop", -1 * k));
  ...
  p.buttonSelector = function (a, b) {
    for (var c = [], d = function d(a, b, c) {
      ...
      } else "object" === _typeof(a) && a.nodeName && (i = e.inArray(a, f), -1 !== i && c.push({
        inst: b,
        node: f[i]
      }));
  ...
  i.Api.register("buttons().containers()", function () {
    ...
    this.iterator(!0, "table", function (c) {
      if (c._buttons) for (var c = p.instanceSelector(b, c._buttons), d = 0, e = c.length; d < e; d++) {
