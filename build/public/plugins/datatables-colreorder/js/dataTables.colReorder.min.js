...
(function (e) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (p, o) {
    p || (p = window);
  ...
  e.extend(i.prototype, {
    ...
    _fnConstruct: function _fnConstruct() {
      ...
      if (g) {
        if (a.s.dt._bInitComplete) b = r(g), a._fnOrderColumns.call(a, b);else {
          var c = !1;
    ...
    _fnStateSave: function _fnStateSave(a) {
      ...
      if (a.aaSorting) {
        ...
        for (d = g.length; b < d; b++) {
          f = g[b]._ColReorder_iOrigCol, a.aoSearchCols[f] = c[b], a.abVisCols[f] = g[b].bVisible, a.ColReorder.push(f);
        }
      } else if (a.order) {
        ...
        for (d = g.length; b < d; b++) {
          f = g[b]._ColReorder_iOrigCol, a.columns[f] = c[b], a.ColReorder.push(f);
        }
      }
    },
    ...
    _fnMouseMove: function _fnMouseMove(a) {
      ...
      for (var d, e = this.s.mouse.toIndex, a = this._fnCursorPosition(a, "pageX"), g = function g() {
