...
!function (e) {
  ...
  "function" == typeof define && define.amd ? define(["jquery"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "function" == typeof require ? e(require("jquery")) : e(jQuery);
}(function (e) {
  "use strict";
  ...
  function l() {
    ...
    u.I = [], u.Id = [], u.O = null, u.baseEltID = null, u.$E = {
      ...
      settings: {
        ...
        mosaicCalcFactor: function mosaicCalcFactor(e, t) {
        ...
        GetResponsive: function GetResponsive(e) {
      ...
      gallery: {
        ...
        firstDisplay: !0,
        posX: 0,
        SetThumbnailActive: function SetThumbnailActive() {
        ...
        PanGallery: function PanGallery(e) {
        ...
        PanGalleryEnd: function PanGalleryEnd(e) {
          var t = 100 * e;
      ...
      ImageLoader: {
        ...
        interval: function interval() {
          for (var e, t = 0, n = u.VOM.ImageLoader.list, i = 0; i < n.length; i++) {
            null != (e = n[i]) && (e.image.width && e.image.height ? (u.VOM.ImageLoader.list[i] = null, e.callback(e.image.width, e.image.height, e.ngitem, e.checks)) : e.checks > u.VOM.ImageLoader.maxChecks ? (u.VOM.ImageLoader.list[i] = null, e.callback(0, 0, e.ngitem, e.checks)) : (t++, e.checks++));
          }
      ...
      switch (u.GOM.displayInterval.from = 0, u.GOM.displayInterval.len = u.I.length, u.galleryDisplayMode.Get()) {
        case "PAGINATION":
          if (u.layout.support.rows) {
            ...
            for (var i = 0; i < _a; i++) {
              var _a2 = u.GOM.items[i];
              _a2.row >= e && _a2.row < t && (-1 == n && (u.GOM.displayInterval.from = i, n = i), u.GOM.displayInterval.len++);
            }
          }
        ...
        case "MOREBUTTON":
          if (u.layout.support.rows) {
            var _e2 = u.GOM.items.length,
                _t = u.O.galleryDisplayMoreStep * (u.GOM.displayedMoreSteps + 1);

            u.GOM.displayInterval.len = 0;

            for (i = 0; i < _e2; i++) {
              u.GOM.items[i].row < _t && u.GOM.displayInterval.len++;
            }
          }
        ...
        case "ROWS":
          if (u.layout.support.rows) {
            var _e3 = u.GOM.items.length,
                _t2 = u.galleryMaxRows.Get();

            u.galleryLastRowFull.Get() && -1 != u.GOM.lastFullRow && _t2 > u.GOM.lastFullRow + 1 && (_t2 = u.GOM.lastFullRow + 1), u.GOM.displayInterval.len = 0;

            for (i = 0; i < _e3; i++) {
              u.GOM.items[i].row < _t2 && u.GOM.displayInterval.len++;
            }
          }
        ...
        case "FULLCONTENT":
          if (u.layout.support.rows && u.galleryLastRowFull.Get() && -1 != u.GOM.lastFullRow) {
            var _e4 = u.GOM.items.length,
                _t3 = u.GOM.lastFullRow + 1;

            u.GOM.displayInterval.len = 0;

            for (i = 0; i < _e4; i++) {
              u.GOM.items[i].row < _t3 && u.GOM.displayInterval.len++;
            }
          }
              ...
              return h = null, d.on("progress", function (e, t) {
                if (t.isLoaded) {
                  ...
                  if (t.img.getAttribute("data-albumidx") == u.GOM.albumIdx) {
                    ...
                    for (var _e5 in o) {
                      o.hasOwnProperty(_e5) && _e5 != u.GOM.curWidth && u.tn.settings.width.l1[_e5] == u.tn.settings.getW() && u.tn.settings.height.l1[_e5] == u.tn.settings.getH() && (a.thumbs.width.l1[_e5] = i.imageWidth, a.thumbs.height.l1[_e5] = i.imageHeight);
                    }

                    o = a.thumbs.width.lN;

                    for (var _e6 in o) {
                      o.hasOwnProperty(_e6) && _e6 != u.GOM.curWidth && u.tn.settings.width.lN[_e6] == u.tn.settings.getW() && u.tn.settings.height.lN[_e6] == u.tn.settings.getH() && (a.thumbs.width.lN[_e6] = i.imageWidth, a.thumbs.height.lN[_e6] = i.imageHeight);
                    }
                  }
                }
        ...
        case "JUSTIFIED":
          e = function () {
            for (var e = 0, t = u.GOM.cache.areaWidth, n = 0, i = 0, a = [], o = 0, r = [], l = !1, s = u.tn.settings.GetResponsive("gutterWidth"), c = u.tn.settings.GetResponsive("gutterHeight"), h = 0, d = 0, m = !1, p = !1, g = u.tn.defaultSize.getOuterHeight(), f = 2 * u.tn.opt.Get("borderHorizontal"), b = 2 * u.tn.opt.Get("borderVertical"), v = 1, O = u.GOM.items.length, y = 0; y < O; y++) {
              var _n = u.GOM.items[y];
              if (1 == _n.deleted) break;

              if (_n.imageWidth > 0) {
                var _i = _n.imageWidth / _n.imageHeight,
                    _u = Math.floor(g * _i);

                if (l && (l = !1, o++, e = 0, m = !1, p = !1, v = 1), _n.imageHeight > _n.imageWidth ? m = !0 : p = !0, e + s + _u < t - v * f) {
                  e += _u + s, r[o] = g;
                  var G = Math.max(m ? h : 0, p ? d : 0);
                  G > 0 && (r[o] = Math.min(r[o], G)), a[o] = y;
                } else {
                  var _n2 = (t - v * f) / (e += s + _u),
                      _i2 = Math.floor(g * _n2);

                  r[o] = _i2, m && (h = Math.max(h, _i2)), p && (d = Math.max(d, _i2)), a[o] = y, l = !0;
                }
            ...
            for (y = 0; y < O; y++) {
              var _e7 = u.GOM.items[y];
              if (!(_e7.imageWidth > 0)) return !1;
              {
                var _l = _e7.imageWidth / _e7.imageHeight,
                    _h = Math.floor(_l * r[o]);

                y == a[o] && (a.length != o + 1 || n + s + _h + f > t) && (_h = t - n - f);

                var _d = parseInt(r[o]);

                _h = parseInt(_h), _e7.resizedContentWidth = _h, _e7.resizedContentHeight = _d, _e7.width = _h + f, _e7.height = _d + u.tn.labelHeight.get() + b, _e7.row = o, _e7.top = i;
                var _m = n;
                u.O.RTL && (_m = t - n - _e7.width), _e7.left = _m, n += _e7.width + s, y == a[o] && (i += _e7.height + c, u.GOM.lastFullRow = o - 1, o++, n = 0);
              }
            }
        ...
        case "MOSAIC":
          e = function () {
            var e = u.GOM.cache.areaWidth,
                ...
                c = 0,
                h = 0;
            var d = u.tn.settings.getMosaic();

            for (var m = 0; m < o; m++) {
              var _e8 = d[s];
              var p = (_e8.c - 1) * u.tn.defaultSize.getOuterWidth() + (_e8.c - 1) * n,
                  g = _e8.w * u.tn.defaultSize.getOuterWidth() + (_e8.w - 1) * n;
              if (h = Math.max(h, p + g), c = Math.max(c, _e8.c - 1 + _e8.w), ++s >= d.length) break;
            }
            ...
            for (m = 0; m < o; m++) {
              var _e9 = u.GOM.items[m],
                  _o = d[s];
              _e9.top = Math.round((_o.r - 1) * u.tn.defaultSize.getOuterHeight() * b) + (_o.r - 1) * t + r * l + u.tn.labelHeight.get() * (_o.r - 1), r > 0 && (_e9.top += t), _e9.left = (_o.c - 1) * Math.round(u.tn.defaultSize.getOuterWidth() * b) + (_o.c - 1) * n, _e9.height = Math.round(_o.h * u.tn.defaultSize.getOuterHeight() * b) + (_o.h - 1) * t + u.tn.labelHeight.get() * _o.h, _e9.resizedContentHeight = _e9.height - u.tn.labelHeight.get() - a, _e9.width = Math.round(_o.w * u.tn.defaultSize.getOuterWidth() * b) + (_o.w - 1) * n, _e9.resizedContentWidth = _e9.width - i, _e9.row = r, 0 == r && (l = Math.max(l, _e9.top + _e9.height)), ++s >= d.length && (s = 0, r++);
            }
    ...
    function E(e) {
      ...
      for (var i = 0; i < t; i++) {
        var _t4 = u.GOM.items[i];
        i >= u.GOM.displayInterval.from && n < u.GOM.displayInterval.len ? (_t4.inDisplayArea = !0, e && (_t4.neverDisplayed = !0), u.GOM.itemsDisplayed++, n++) : _t4.inDisplayArea = !1;
      }
      ...
      for (i = 0; i < t; i++) {
        var _e10 = u.GOM.items[i];

        if (_e10.inDisplayArea) {
          if (-1 == u.GOM.clipArea.top && (u.GOM.clipArea.top = _e10.top), _e10.top - u.GOM.clipArea.top <= -1 && (u.GOM.clipArea.top = _e10.top), u.GOM.clipArea.height = Math.max(u.GOM.clipArea.height, _e10.top - u.GOM.clipArea.top + _e10.height), _e10.neverDisplayed) {
            var l = u.GOM.cache.containerOffset.top + (_e10.top - u.GOM.clipArea.top);

            if (l + _e10.height >= u.GOM.cache.viewport.t - 50 && l <= u.GOM.cache.viewport.t + u.GOM.cache.viewport.h + 50) {
              var _t5 = u.I[_e10.thumbnailIdx];
              null == _t5.$elt && A(_t5, _e10.thumbnailIdx, i), a.push({
                idx: i,
                delay: n,
                top: _e10.top,
                left: _e10.left
          ...
          _e10.displayed = !1;
          var _t6 = u.I[_e10.thumbnailIdx];
          null != _t6.$elt && _t6.$elt.css({
            opacity: 0,
            display: "none"
          });
        }
      ...
      k(o), u.GOM.thumbnails2Display.forEach(function (e) {
        !function (e, t) {
          ...
          switch (u.tn.opt.Get("displayTransition")) {
            ...
            case "SCALEUP":
              {
                var _e11 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SCALEDOWN":
              {
                var _e12 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SLIDEUP":
              {
                var _e13 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SLIDEDOWN":
              {
                var _e14 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "FLIPUP":
              {
                var _e15 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "FLIPDOWN":
              {
                var _e16 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SLIDEUP2":
              {
                var _e17 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SLIDEDOWN2":
              {
                var _e18 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SLIDERIGHT":
              {
                var _e19 = u.tn.opt.Get("displayTransitionStartVal");
            ...
            case "SLIDELEFT":
              {
                var _e20 = u.tn.opt.Get("displayTransitionStartVal");
    ...
    function U() {
      if (-1 != u.GOM.albumIdx) for (var e = u.GOM.items.length, t = 0; t < e; t++) {
    ...
    this.initiateGallery2 = function (e, t) {
      if (u.O = t, u.$E.base = jQuery(e), u.baseEltID = u.$E.base.attr("id"), null == u.baseEltID) {
        for (var n = "", i = !0; i;) {
          document.getElementById("my_nanogallery" + n) ? "" == n ? n = 1 : n++ : (i = !1, u.baseEltID = "my_nanogallery" + n);
        }
      ...
      if (u.O.$markup = [], function () {
        ...
        if (void 0 !== b) switch (r(b)) {
          case "string":
            {
              ...
              for (n = 0; n < _e21.length; n++) {
                var _t8 = oe();

                _t8 = ne(_e21[n].trim(), _t8), null != _t8 && u.tn.hoverEffects.level1.push(_t8);
              }
          ...
          case "object":
            {
              ...
              _e22 = jQuery.extend(_e22, b), _e22 = ne(_e22.name, _e22), null != _e22 && u.tn.hoverEffects.level1.push(_e22);
              break;
            }
          ...
          case "array":
            for (n = 0; n < b.length; n++) {
              ...
              _e23 = jQuery.extend(_e23, b[n]), _e23 = ne(_e23.name, _e23), null != _e23 && u.tn.hoverEffects.level1.push(_e23);
            }
        ...
        switch (r(v)) {
          case "string":
            {
              ...
              for (n = 0; n < _e24.length; n++) {
                var _t9 = oe();

                _t9 = ne(_e24[n].trim(), _t9), null != _t9 && u.tn.hoverEffects.std.push(_t9);
              }
          ...
          case "object":
            {
              ...
              _e25 = jQuery.extend(_e25, v), _e25 = ne(_e25.name, _e25), null != _e25 && u.tn.hoverEffects.std.push(_e25);
              break;
            }
          ...
          case "array":
            for (n = 0; n < v.length; n++) {
              ...
              _e26 = jQuery.extend(_e26, v[n]), _e26 = ne(_e26.name, _e26), null != _e26 && u.tn.hoverEffects.std.push(_e26);
            }
        ...
        for (var O = ["xs", "sm", "me", "la", "xl"], y = 0; y < O.length; y++) {
          null != u.O["galleryMosaic" + O[y].toUpperCase()] && (u.tn.settings.mosaic.lN[O[y]] = JSON.parse(JSON.stringify(u.O["galleryMosaic" + O[y].toUpperCase()])), u.tn.settings.mosaic.l1[O[y]] = JSON.parse(JSON.stringify(u.O["galleryMosaic" + O[y].toUpperCase()])), u.tn.settings.mosaicCalcFactor("lN", O[y]), u.tn.settings.mosaicCalcFactor("l1", O[y]));
        }

        for (y = 0; y < O.length; y++) {
          null != u.O["galleryL1Mosaic" + O[y].toUpperCase()] && (u.tn.settings.mosaic.l1[O[y]] = JSON.parse(JSON.stringify(u.O["galleryL1Mosaic" + O[y].toUpperCase()])), u.tn.settings.mosaicCalcFactor("l1", O[y]));
        }
    ...
    function ne(e, t) {
      ...
      if (i.length >= 4) {
        if (t.name = "", t.type = i[1], t.from = i[2], t.to = i[3], i.length >= 5) for (var a = 4; a < i.length; a++) {
          ...
          if (!0 !== r) if ("HOVERIN" != (o = o.toUpperCase())) {
            if ("HOVEROUT" != o) {
              if ("KEYFRAME" != o) {
    ...
    function ae(e) {
      for (var a = [], o = 0; o < e.length; o++) {
        switch (e[o].name.toUpperCase()) {
          case "BORDERLIGHTER":
            {
              var _i3 = t(se().thumbnail.borderColor),
                  _r = "thumbnail_borderColor_" + _i3 + "_" + n(.5, _i3);
          ...
          case "BORDERDARKER":
            {
              var _i4 = t(se().thumbnail.borderColor),
                  _r2 = "thumbnail_borderColor_" + _i4 + "_" + n(-.5, _i4);
    ...
    function we(e) {
      if (u.O.thumbnailOpenInLightox) if (u.O.thumbnailOpenOriginal) Me(u.I[e]);else {
        ...
        for (var _n3 = e + 1; _n3 < i; _n3++) {
          var _e27 = u.I[_n3];

          if ("image" == _e27.kind && _e27.isToDisplay(u.VOM.albumID) && "" == _e27.destinationURL) {
            var _i5 = new c(_n3);

            u.VOM.items.push(_i5), t.push(_e27);
          }
        }
        ...
        for (var _n4 = 0; _n4 < e; _n4++) {
          ...
          if ("image" == _e28.kind && _e28.isToDisplay(u.VOM.albumID) && "" == _e28.destinationURL) {
            var _i6 = new c(_n4);

            _i6.mediaNumber = o, u.VOM.items.push(_i6), t.push(_e28), o++;
          }
        }

        for (var _e29 = 0; _e29 < a; _e29++) {
          u.VOM.items[_e29].mediaNumber = o, o++;
        }
        ...
        if (null === r) {
          if (u.VOM.viewerDisplayed) {
            ...
            var _e30 = u.VOM.content.current.NGY2Item();

            var l = '<div class="nGY2ViewerMediaLoaderDisplayed"></div>';
            "img" == _e30.mediaKind && 0 != _e30.imageWidth && 0 != _e30.imageHeight && (l = '<div class="nGY2ViewerMediaLoaderHidden"></div>'), u.VOM.content.current.$media.append(l + _e30.mediaMarkup), et(u.VOM.content.next, 0), et(u.VOM.content.previous, 0), "img" == _e30.mediaKind && u.VOM.ImageLoader.loadImage(Ke, _e30), Ze("");
          } else De();
    ...
    function De(e) {
      ...
      for (var y = '<div class="nGY2ViewerToolsTopRight nGEvent"><div class="toolbar nGEvent">', G = u.O.viewerTools.topRight.split(","), M = (v = 0, G.length); v < M; v++) {
        y += Be(G[v]);
      }

      y += "</div></div>", u.VOM.$toolbarTR = jQuery(y).appendTo(u.VOM.$viewer), Pe(), ngscreenfull.enabled && u.O.viewerFullscreen && (ngscreenfull.request(), u.VOM.viewerIsFullscreen = !0), function () {
        ...
        finish: function finish() {
          u.VOM.viewerDisplayed = !0, Xe(0), null == u.VOM.hammertime && (u.VOM.hammertime = new NGHammer.Manager(u.VOM.$baseCont[0], {
            ...
            if (Ne()) {
              if (null != e.target.dataset.ngy2_lightbox_thumbnail) {
                ...
                if (!isNaN(t) && n != u.VOM.content.current.vIdx) {
                  if (n > u.VOM.content.current.vIdx) {
                    ...
                    var _e31 = '<div class="nGY2ViewerMediaLoaderDisplayed"></div>';
                    "img" == i.mediaKind && 0 != i.imageWidth && 0 != i.imageHeight && (_e31 = '<div class="nGY2ViewerMediaLoaderHidden"></div>'), u.VOM.content.next.$media.append(_e31 + i.mediaMarkup), "img" == i.mediaKind ? u.VOM.ImageLoader.loadImage(Ke, i) : Ce(u.VOM.content.next.$media), Ze("nextImage");
                  } else {
                    at("lightboxPreviousImage"), u.VOM.content.previous.$media.empty();
                    var a = u.I[t];
                    u.VOM.content.previous.vIdx = n;
                    var _e32 = '<div class="nGY2ViewerMediaLoaderDisplayed"></div>';
                    "img" == a.mediaKind && 0 != a.imageWidth && 0 != a.imageHeight && (_e32 = '<div class="nGY2ViewerMediaLoaderHidden"></div>'), u.VOM.content.previous.$media.append(_e32 + a.mediaMarkup), "img" == a.mediaKind ? u.VOM.ImageLoader.loadImage(Ke, a) : Ce(u.VOM.content.previous.$media), Ze("previousImage");
                  }
              ...
              if (Ve(e.srcEvent), 0 == u.VOM.toolbarsDisplayed) s(Ae, 100, !1)(), u.VOM.singletapTime = new Date().getTime();else {
            ...
            if (Ne()) if (Ve(e.srcEvent), 0 == u.VOM.toolbarsDisplayed) s(Ae, 100, !1)(), u.VOM.singletapTime = new Date().getTime();else {
              if (new Date().getTime() - u.VOM.singletapTime < 400) return;
      ...
      if (u.VOM.swipePosX = e, null == u.CSStransformName) ;else {
        ...
        if (u.O.imageTransition.startsWith("SWIPE")) {
          ...
          if ("SWIPE" == u.O.imageTransition && (i = 1), e > 0) {
            var _a3 = u.VOM.window.lastWidth;
            t.mediaTransition() && (u.VOM.content.previous.$media[0].style[u.CSStransformName] = "translate(" + (-_a3 + e) + "px, 0px) scale(" + i + ")"), n.mediaTransition() && (u.VOM.content.next.$media[0].style[u.CSStransformName] = "translate(" + _a3 + "px, 0px) scale(" + i + ")");
          } else {
            var _a4 = -u.VOM.window.lastWidth;

            n.mediaTransition() && (u.VOM.content.next.$media[0].style[u.CSStransformName] = "translate(" + (-_a4 + e) + "px, 0px) scale(" + i + ")"), t.mediaTransition() && (u.VOM.content.previous.$media[0].style[u.CSStransformName] = "translate(" + _a4 + "px, 0px) scale(" + i + ")");
          }
        }
        ...
        if ("SLIDEAPPEAR" == u.O.imageTransition) if (u.VOM.content.previous.$media[0].style[u.CSStransformName] = "", u.VOM.content.next.$media[0].style[u.CSStransformName] = "", e < 0) {
          var _i7 = -e / u.VOM.window.lastWidth;

          n.mediaTransition() && et(u.VOM.content.next, _i7), t.mediaTransition() && et(u.VOM.content.previous, 0);
        } else {
          var _i8 = e / u.VOM.window.lastWidth;

          t.mediaTransition() && et(u.VOM.content.previous, _i8), n.mediaTransition() && et(u.VOM.content.next, 0);
        }
      }
    }
    ...
    function it(e) {
      ...
      return function (e) {
        ...
        for (var _e33 = 0; _e33 < t.length; _e33 += 1) {
          if (t[_e33] === document.body) return null;
          if (a(t[_e33])) return t[_e33];
        }
      ...
      void 0 === window.NGY2Item && (window.NGY2Tools = function () {
        ...
        return e.FilterAlbumName = function (e, t) {
          ...
          if (!(this.albumList.length > 0)) {
            ...
            if (null !== this.blockList) for (a = 0; a < this.blockList.length; a++) {
        ...
        t.Get = function (e, t) {
          ...
          if (null !== e.O.titleTranslationMap) {
            var _t10 = e.O.titleTranslationMap.find(function (e) {
              return e.title === n;
            });

            void 0 !== _t10 && (n = _t10.replace);
          }

          if (-1 != r && 0 != r && "image gallery by nanogallery2 [build]" != n && e.O.thumbnailLevelUp && 0 == u.getContentLength(!1) && "" == e.O.album) {
            var _n5 = new t("0");

            e.I.push(_n5), u.contentLength += 1, _n5.title = "UP", _n5.albumID = r, _n5.kind = "albumUp", _n5.G = e, jQuery.extend(!0, _n5.thumbs.width, e.tn.defaultSize.width), jQuery.extend(!0, _n5.thumbs.height, e.tn.defaultSize.height);
          }
            ...
            case "TITLE":
              {
                ...
                for (; _e34 = _t11.exec(n);) {
                  _i9.push(_e34[1].replace(/^\s*|\s*$/, ""));
                }

                c.setTags(_i9), n = n.split("#").join("");
                break;
              }
            ...
            case "DESCRIPTION":
              {
                ...
                for (; _e35 = _t12.exec(i);) {
                  _n6.push(_e35[1].replace(/^\s*|\s*$/, ""));
                }

                c.setTags(_n6), i = i.split("#").join("");
                break;
              }
        ...
        return t.get_nextId = function () {
          ...
          if (void 0 === i || "" == i || null == i) for (var r = 0; r < o.length; r++) {
            void 0 === a || "" == a ? (this.thumbs.url.l1[o[r]] = e, this.thumbs.height.l1[o[r]] = n, this.thumbs.width.l1[o[r]] = t, this.thumbs.url.lN[o[r]] = e, this.thumbs.height.lN[o[r]] = n, this.thumbs.width.lN[o[r]] = t) : (this.thumbs.url[a][o[r]] = e, this.thumbs.height[a][o[r]] = n, this.thumbs.width[a][o[r]] = t);
          ...
          } else if (null != t.$elt) for (h = 0; h < t.$elt.length; h++) {
            if (null != t.$elt[h]) {
          ...
          if (null != t.$elt) for (var i = 0; i < t.$elt.length; i++) {
        ...
        case "shoppingCartUpdate":
          ...
          for (var o = n, r = i, l = 0; l < a.shoppingCart.length; l++) {
            if (a.shoppingCart[l].ID == o) {
              ...
              var _e36 = a.I[a.shoppingCart[l].idx];
              a.ThumbnailToolbarOneCartUpdate(_e36), 0 == r && a.shoppingCart.splice(l, 1), null !== (u = a.O.fnShoppingCartUpdated) && ("function" == typeof u ? u(a.shoppingCart, _e36, "api") : window[u](a.shoppingCart, _e36, "api"));
              break;
            }
          }
  ...
  function (e, t) {
    e.ngimagesLoaded = function (e, t) {
      ...
      function o(e, t, i) {
        ...
        "string" == typeof e && (e = document.querySelectorAll(e)), this.elements = function (e) {
          var t = [];
          if (Array.isArray(e)) t = e;else if ("number" == typeof e.length) for (var n = 0; n < e.length; n++) {
            t.push(e[n]);
          } else t.push(e);
          return t;
    ...
    var t,
      ...
      function m(e, n, i, a, o, r, l) {
        ...
        for (s in n) {
          n.hasOwnProperty(s) && (c = "function" == typeof (u = l[s]) ? u : t[u], n[s] = p(i[s], a[s], c, h));
        }
      ...
      }), "function" == typeof SHIFTY_DEBUG_NOW && (e.timeoutHandler = f), "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = v : "function" == typeof define && define.amdDISABLED ? define(function () {
        return v;
    ...
    n.shallowCopy(n.prototype.formula, {
      ...
      function d(e, t, n) {
        var i = t.match(e),
            a = t.replace(e, "VAL");
        if (i) for (var o, r = i.length, l = 0; l < r; l++) {
      ...
      e.prototype.filter.token = {
        tweenCreated: function tweenCreated(i, a, o, r) {
          var u, c;
        ...
        beforeTween: function beforeTween(t, n, i, a) {
          !function (t, n) {
            e.each(n, function (e) {
              var i,
                  a = n[e].chunkNames,
        ...
        afterTween: function afterTween(t, n, i, a) {
  ...
  function (e, t, n, i) {
    ...
    function d(e, t, n) {
      var i;
      if (e) if (e.forEach) e.forEach(t, n);else if (void 0 !== e.length) for (i = 0; i < e.length;) {
        t.call(n, e[i], i, e), i++;
      } else for (i in e) {
      ...
      recognize: function recognize(e) {
        ...
        if (!t.stopped) {
          ...
          for (var o = 0; o < i.length;) {
            n = i[o], 2 === t.stopped || a && n != a && !n.canRecognizeWith(a) ? n.reset() : n.recognize(e), !a && 14 & n.state && (a = t.curRecognizer = n), o++;
          }
        }
      },
      get: function get(e) {
  ...
  e = function e() {
    ...
    for (e = document.querySelectorAll("[data-nanogallery2-lightbox]"), t = 0; t < e.length; t++) {
      e[t].classList.add("NGY2ThumbnailLightbox"), e[t].addEventListener("click", function (e) {
        e.preventDefault();
...
function (e) {
  ...
  "function" == typeof define && define.amd ? define(["jquery", "nanogallery2"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "function" == typeof require ? e(require(["jquery", "nanogallery2"])) : e(jQuery);
}(function (e) {
  jQuery.nanogallery2.data_nano_photos_provider2 = function (e, t) {
    var n = e,
        i = function i(t, _i10, s, c) {
      ...
      try {
        ...
        n.O.debugMode && console.log("nanoPhotosProvider2 URL: " + d), jQuery.getJSON(d, function (e, a, d) {
          clearTimeout(m), r(!1), o(h, e), "ok" == e.nano_status ? (u(t), null != _i10 && _i10(s, c, null)) : l(n, "Could not retrieve nanoPhotosProvider2 data. Error: " + e.nano_status + " - " + e.nano_message);
        }).fail(function (e, t, i) {
          clearTimeout(m), r(!1);
          var a = "";
      ...
      jQuery.each(t.album_content, function (e, i) {
        ...
        if ("album" == c && (s(l, h) || (d = !0), "" == n.O.album && "" == n.O.photoset || (d = !0)), "image" == c || !d) {
          ...
          for (var f = n.GOM.curNavLevel, b = ["xs", "sm", "me", "la", "xl"], v = 0; v < b.length; v++) {
            g.thumbs.url[f][b[v]] = o + a(i.t_url[v]), g.thumbs.width[f][b[v]] = parseInt(i.t_width[v]), g.thumbs.height[f][b[v]] = parseInt(i.t_height[v]);
          }
    ...
    var n = e,
      ...
      try {
        ...
        jQuery.getJSON(s + "&callback=?", function (s) {
          ...
          clearTimeout(p), r(!1), a(c, u, s), h(e), null != t && t(_i11, o, null);
        }).fail(function (e, t, i) {
          clearTimeout(p), r(!1);
          var a = "";
      ...
      for (var l = ["xs", "sm", "me", "la", "xl"], s = 0; s < l.length; s++) {
        if ("image" == a) {
          if ("auto" == n.tn.settings.width[e][l[s]]) {
            ...
            t.height[e][l[s]] = n.tn.settings.getH(e, l[s]), t.width[e][l[s]] = n.tn.settings.getH(e, l[s]) * _a5, t.url[e][l[s]] = i.baseUrl + "=h" + n.tn.settings.getH(e, l[s]);
            continue;
          }
          ...
          if ("auto" == n.tn.settings.height[e][l[s]]) {
            ...
            t.width[e][l[s]] = n.tn.settings.getW(e, l[s]), t.height[e][l[s]] = n.tn.settings.getW(e, l[s]) * _a6, t.url[e][l[s]] = i.baseUrl + "=w" + n.tn.settings.getW(e, l[s]);
            continue;
          }
    ...
    var n = e,
      ...
      var g = setTimeout(function () {
        ...
        jQuery.getJSON(i + "&page=" + d + "&jsoncallback=?", function (v, O, y) {
          ...
          } else if ("NONE" == n.O.photoset.toUpperCase() || "NONE" == n.O.album.toUpperCase()) f = f.concat(v.photos.photo), G = v.photos.pages;else {
          ...
          G > d ? b(i, d + 1) : (clearTimeout(g), c(!1), f = u(f, n.O.tagBlockList), "album" == m ? r(s, e, f) : o(s, e, f), p(e), null != t && t(_a7, l, null));
        }).fail(function (e, t, i) {
    ...
    function l(e, t, i) {
      ...
      for (var o = ["xs", "sm", "me", "la", "xl"], r = 0; r < o.length; r++) {
        if ("auto" == n.tn.settings.width[i][o[r]] || "" == n.tn.settings.width[i][o[r]]) {
          var _l2 = s("height_", Math.ceil(n.tn.settings.height[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].h[o[r]]), t);

          e.url[i][o[r]] = _l2.url, e.width[i][o[r]] = _l2.width, e.height[i][o[r]] = _l2.height;
        } else if ("auto" == n.tn.settings.height[i][o[r]] || "" == n.tn.settings.height[i][o[r]]) {
          var _l3 = s("width_", Math.ceil(n.tn.settings.width[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].w[o[r]]), t);

          e.url[i][o[r]] = _l3.url, e.width[i][o[r]] = _l3.width, e.height[i][o[r]] = _l3.height;
        } else {
          var _l4 = "height_",
              _u2 = Math.ceil(n.tn.settings.height[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].h[o[r]]);

          n.tn.settings.width[i][o[r]] > n.tn.settings.height[i][o[r]] && (_l4 = "width_", _u2 = Math.ceil(n.tn.settings.width[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].w[o[r]]));

          var _c = s(_l4, _u2, t);

          e.url[i][o[r]] = _c.url, e.width[i][o[r]] = _c.width, e.height[i][o[r]] = _c.height;
        }
      }
